...
<div class="container" id="nav-container"> 
  ...
  <main>
   ...
   <div class="row mb-5">
        <div class="col-md-4">  
          <div class="card">
             <img class="card-img-top"  src="img/antonio.jpg">
            <div class="card-body">
              <h4 class="card-title">Diretor geral</h4>
              <h6 class="card-subtitle mb-2 text-muted">Gestão administrativa </h6>
               <p class="card-text">José Antonio Costa<p>
                <p class="card-text">josé.costa@etlg.com.br<p>
        ...
        <div class="col-md-4">  
          <div class="card">
            <img class="card-img-top"  src="img/ana.jpg">
            <div class="card-body">
              <h4 class="card-title">Coordenadora Pedagogica </h4>
              <h6 class="card-subtitle mb-2 text-muted">Gestão administrativa </h6>
               <p class="card-text">Ana Lucia Pedrosa<p>
                <p class="card-text">ana.pedrosa@etlg.com.br<p>
        ...
        <div class="col-md-4">  
          <div class="card">
             <img class="card-img-top"  src="img/pedro.jpg">
            <div class="card-body">
              <h4 class="card-title">Diretor Administrativo </h4>
               <h6 class="card-subtitle mb-2 text-muted">Gestão administrativa </h6>
               <p class="card-text">Pedro Albuquerque<p>
                <p class="card-text">pedro.albuquerque@etlg.com.br<p>
