        ...
        <div class="container">
            <div class="row">
              <div class="col-12"> 
               ...
               <h3 class="main-title" >Química</h3><br>
              </div>
              <div class="col-md-6">
               <img class="img-fluid" src="img/quimica31.jpg" alt="ETGL">
              </div>
              <div class="col-md-6">
                <h3 class="about-title"> O quê é? </h3>
                <p>O TÉCNICO EM QUÍMICA é o profissional irá habilitarO estudante vai conhecer insumos, equipamentos e métodos utilizados pela indústria química e se aprofundar no desenvolvimento de produtos e materiais, processos laboratoriais, análises químicas, físico-químicas e microbiológicas. O técnico em química deve estar preparado para a criação e transformação de produtos das mais diversas áreas e categorias do mercado.</p>

                <h2 class="about-title">Onde Trabalhar<h2>
                <p>Indústrias químicas, empresas privadas ou públicas , laboratórios de análise, de pesquisa, de controle ambiental e de controle de qualidade</p><br><br>
