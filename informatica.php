        ...
        <div class="container">
            <div class="row">
              <div class="col-12"> 
               ...
               <h3 class="main-title" >Informática</h3><br>
              </div>
              <div class="col-md-6">
                <img class="img-fluid" src="img/proj21.jpg" alt="ETGL">
              </div>
              <div class="col-md-6">
                <h3 class="about-title"> O quê é? </h3>
                <p>O TÉCNICO EM INFORMÁTICA é o profissional irá habilitar profissionais capazes de encontrar soluções para a diversos problemas atuando na área de TI . O estudante aprenderá a criar sites e programas, além de habilidades que giram em torno da melhor funcionalidade para soluções de diversos problemas empresariais O profissional da informática pode trabalhar tanto em empresas privadas, públicas e como freelancer.</p>
