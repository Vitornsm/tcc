        ...
        <div class="container">
            <div class="row">
              <div class="col-12"> 
               ...
               <h3 class="main-title" >Cursos Técnicos</h3><br>
              </div>
              <div class="col-md-6">
                <img class="img-fluid" src="img/tecnico.png" alt="ETGL">
              </div>
              <div class="col-md-6">
                <h3 class="about-title"> Porque fazer um curso Técnico </h3>
                <p>Ele é uma boa alternativa para quem quer entrar começar a trabalhar logo ou quer conhecer uma determinada área antes de fazer a graduação em si.  </p>

                <p>Os cursos técnicos podem ser realizados ao mesmo tempo em que o aluno está no Ensino Médio. Com isso é possível ter uma formação direcionada ao mercado de trabalho e ao sair da escola pode ter mais chances de conseguir um emprepo.</p>

               <p>Também é possível fazer o curso depois que terminar o Ensino Médio. Neste caso, as chances de entrar no mercado logo no início do curso são grandes, algo que não acontece sempre na graduação. </p>
               <p>Ao ser um “estudante técnico”, ao longo do curso o aluno se desenvolve por meio de estágios e já garante experiência para trabalhar na área de formação. </p>
