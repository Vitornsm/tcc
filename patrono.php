    ...
    <div class="container-fluid">
      ...
      <div id="about-area">
        <div class="container">
            <div class="row">
              <div class="col-12"> 
                <br><br><h3 > Laurindo Guimarães</h3>
              </div>
              <div class="col-md-6">
                <img class="img-fluid" src="img/laurindo.jpg" alt="Laurindo Guimarães">
              </div>
              <div class="col-md-6">
                <h3 class="about-title"> Um homem que tinha mais que um sonho , um ideal </h3>
                <p>Laurindo Guimarães era proveniente de uma família da elite cafeeira paulista que assumiu papel importante nos acontecimentos políticos engendrados no século XIX. Seu avô paterno, Francisco de Paula Souza e Mello, participara do processo de emancipação política brasileira como deputado das Cortes de Lisboa em 1821 e, com o desenrolar dos acontecimentos, tornou-se ainda membro da Assembléa Constituinte (Câmara Temporária), logo dissolvida pelo Imperador D. Pedro I em 1823. Decorridos dez anos obteve vaga no Senado, lutando pela implementação de um governo representativo e durante o período regencial ocupou o cargo de Ministro do Império.</p>
                <p>Laurindo Gumarães,  formou-se em medicina . Foi deputado , ministro da agricultura .</p>
                <p> Foi professor da Faculdade de Piracicaba , porém sempre tendo a educação como sua  maior preocupação m e sua atuação marcada por inúmeras realizações no setor educacional, principalmente no tocante à necessidade de ensino profissionalizante na região.</p>
<p>Pela sua vida pública, sempre voltada para o campo da educação, e pela sua grande dedicação em prol da Escola Técnica </p>
