    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown1">
                    <li><a href="secretariacontato.html" class="dropdown-item" style="color: #F00">Solicitação Documentação</a></li>   
                </ul>
            </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown1">
                    <li><a class="dropdown-item" href="ContatoSuport.html" style="color: #F00">Contato</a></li>
                </li>
                  </ul>
            </li>
      </ul>
        ...
        <div class="container">
            <div class="row">
              <div class="col-12"> 
               ...
               <h3 class="main-title" >Logística</h3><br>
              </div>
              <div class="col-md-6">
                <img class="img-fluid" src="img/log.jpg" alt="ETGL">
              </div>
              <div class="col-md-6">
                <h3 class="about-title"> O quê é? </h3>
                <p>O TÉCNICO EM LOGÍSTICA é o profissional que executa e colabora na gestão dos processos de planejamentos, operações e controles de programação da produção de bens e serviços, programação de manutenção de máquinas e de equipamentos, de compras, de recebimento, de armazenamento, de estoques, de movimentação, de expedição, transporte e distribuição de materiais e produtos, utilizando tecnologia de informação. Presta atendimento aos clientes. Implementa os procedimentos de controle de custos, qualidade, segurança e higiene do trabalho no sistema logístico.</p>

                <h2 class="about-title">Onde Trabalhar<h2>
                <p>Instituições públicas, privadas e do terceiro setor.</p><br><br>
